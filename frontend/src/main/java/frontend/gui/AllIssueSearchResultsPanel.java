...
public class AllIssueSearchResultsPanel extends ReportedIssueSearchResultsPanelUser {
    ...
    protected JTable createTable(JFrame mainFrame, List<String> issuesTitles) {
        ...
        buttonColumn.setCellEditor(new IconCellEditorAllIssue(mainFrame, "/frontend/gui/images/reportIssue.png", ICON_WIDTH, ICON_HEIGHT, resultsTable));
