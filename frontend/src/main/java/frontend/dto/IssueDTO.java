...
public class IssueDTO {
    ...
    /**
     * Metodo di utilità per convertire il tipo della issue da stringa a enumeration IssueType.
     *
     * @param type Il tipo della issue sotto forma di stringa (es. "Bug", "Question").
     */
